      ...
      <div className="mx-auto max-w-4xl">
        ...
        >
          ...
          <p className="mx-auto max-w-2xl text-lg text-slate-600">
            Обережно, кульки-лопайки! Твоє завдання — відкрити всі клітинки і не влучити в пастку. Дивись на цифри, вони допоможуть тобі розгадати, де сховалися кульки. Позначай небезпечні місця прапорцями та вигравай!
          </p>
        </motion.div>
