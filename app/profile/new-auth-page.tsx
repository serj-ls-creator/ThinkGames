...
import { getLevelProgress, loadProgressFromSupabase } from '../../src/lib/supabase-points'
...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    const loadUserStats = async () => {
      const { success, data } = await loadProgressFromSupabase(user.id)
      if (success && data) {
        setUserStats({
          math: getLevelProgress(data.math),
          ukrainian: getLevelProgress(data.ukrainian),
          dutch: getLevelProgress(data.dutch)
        })
      }
    }
